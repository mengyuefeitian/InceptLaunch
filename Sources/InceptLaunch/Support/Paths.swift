...
struct RealDataDirectoryAccessedFromTestHostError: Error, CustomStringConvertible {
    var description: String {
        "InceptLaunchPaths.applicationSupportDirectory() was called from a " +
        "`swift test` host process without INCEPTLAUNCH_DATA_DIR set. A test " +
        ...
        "real ~/Library/Application Support/InceptLaunch/ directory. This has " +
